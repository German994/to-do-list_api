...
export const getAllTodosController = async (req, res) => {
  try {
    ...
    res.status(500).json({ status: 'error', message: 'Error al obtener todos los todos' });
  }
}
...
export const getTodosController = async (req, res) => {
  try {
    ...
    res.status(500).json({ status: 'error', message: 'Error al obtener los todos del usuario' });
  }
}
...
export const getTodoByIdController = async (req, res) => {
  try {
    ...
    if (!todo) return res.status(404).json({ status: 'error', message: 'Todo no encontrado' });

    res.status(200).json(todo);
  } catch (error) {
    res.status(500).json({ status: 'error', message: 'Error al obtener el todo' });
  }
}
...
export const createTodoController = async (req, res) => {
  try {
    ...
    if (!newTodo) return res.status(404).json({ message: 'Error al crear un nuevo todo' })
...
export const updateTodoController = async (req, res) => {
  try {
    ...
    if (!updatedTodo) 
      return res.status(404).json({ status: 'error', message: 'Todo no encontrado' });

    res.status(200).json(updatedTodo);
  } catch (error) {
    res.status(500).json({ status: 'error', message: 'Error al actualizar el todo' });
  }
}
...
export const deleteTodoController = async (req, res) => {
  try {
    ...
    if (!deleteTodo) return res.status(404).json({ message: 'Todo no encontrado' })
